...
def token_test_case_002(BASE_URL: str):
...
def token_test_case_003(BASE_URL: str):
    ...
    helpers.POST(TOKEN_URL, data=invalid_admin_cre, status_code=HTTPStatus.NOT_ACCEPTABLE)


def token_test_case_004(BASE_URL: str):
    ...
    # Step 3: Verify token count does not exceed MAX_EXECUTIVE_TOKENS
...
def token_test_case_005(BASE_URL: str):
...
def token_test_case_006(BASE_URL: str):
...
def token_test_case_007(BASE_URL: str):
...
def token_test_case_008(BASE_URL: str):
...
def token_test_case_009(BASE_URL: str):
...
def token_test_case_010(BASE_URL: str):
...
def token_test_case_011(BASE_URL: str):
...
def token_test_case_012(BASE_URL: str):
...
def token_test_case_013(BASE_URL: str):
...
def token_test_case_014(BASE_URL: str):
...
def token_test_case_015(BASE_URL: str):
...
def token_test_case_016(BASE_URL: str):
...
def token_test_case_017(BASE_URL: str):
...
def token_test_case_018(BASE_URL: str):
...
def token_test_case_019(BASE_URL: str):
...
def token_test_case_020(BASE_URL: str):
